...
{
public:
  MenuItem(const String& name, const String& display_name, const String &display_name_short)
    : m_name(name), m_display_name(display_name), m_display_name_short(display_name_short),
    m_active(false), m_onchange_cb(nullptr)
  {
  }
  virtual ~MenuItem();
...
{
public:
  MenuItemNumericRange(const String& name, const String& display_name, const String& display_name_short, const int start, const int end, const int current_value)
    : MenuItem(name, display_name, display_name_short), m_start(start), m_end(end), m_current(current_value)
  {}
...
{
public:
  MenuItemBoolean(const String& name, const String& display_name, const String& display_name_short, const bool current_value)
    : MenuItem(name, display_name, display_name_short), m_current(current_value)
  {}
